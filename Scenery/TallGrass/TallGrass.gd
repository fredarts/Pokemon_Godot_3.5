...
const grass_overlay_texture = preload("res://Scenery/TallGrass/stepped_tall_grass.png")
const GrassStepEffect = preload("res://Scenery/TallGrass/GrassStepEffect.tscn")
